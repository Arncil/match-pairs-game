...
export default class GameHard extends React.Component {
    constructor(props) {
        super(props)
    ...
    generateCardSet = () => {
        ...
        const makeItHarder = (easySet) => {
            ...
            for (let i = 0; i < 15; i++) {
                ...
                const index3 = Math.floor(Math.random() * easySet.length)
                const randomElement3 = easySet[index3]
                const index4 = Math.floor(Math.random() * easySet.length)
                const randomElement4 = easySet[index4]
                easySet.splice(index1, 1)
                const randomElement = randomElement1 + randomElement2 + randomElement3 + randomElement4
